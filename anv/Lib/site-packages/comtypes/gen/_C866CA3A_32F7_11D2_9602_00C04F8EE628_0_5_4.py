...
__all__ = [
    'SAFT12kHz16BitMono', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechMemoryStream', 'eLEXTYPE_PRIVATE3', 'SP_VISEME_19',
    'DISPID_SVEViseme', 'SP_VISEME_10', 'SPFM_OPEN_READWRITE',
    'DISPID_SVGetAudioOutputs', 'DISPID_SOTDataKey', 'SITooQuiet',
    '_RemotableHandle', 'DISPID_SPPsCount',
    'DISPID_SpeechObjectTokenCategory', 'SPEI_RECOGNITION',
    'DISPID_SOTId', 'Speech_StreamPos_Asap', 'DISPID_SLWsItem',
    'SpeechCategoryAudioOut', 'DISPID_SDKEnumKeys',
    'SRADefaultToActive', 'ISpRecognizer', 'ISpeechPhraseElement',
    'SPEI_ADAPTATION', 'SAFT24kHz8BitStereo', 'ISpeechRecoContext',
    'DISPID_SAFType', 'DISPID_SBSSeek', 'SPLO_STATIC',
    'SpeechVoiceSkipTypeSentence', 'SPPS_Function',
    'SDKLCurrentConfig', 'SpeechGrammarWordType', 'SWTDeleted',
    'SVEViseme', 'SSTTWildcard', 'SPRECOGNIZERSTATUS', 'SPRECOSTATE',
    'SPEI_TTS_PRIVATE', 'eLEXTYPE_PRIVATE12', 'SVF_Emphasis',
    'DISPID_SPRuleConfidence', 'ISpStream', 'SPSHORTCUTPAIRLIST',
    'SRAORetainAudio', 'SPAUDIOBUFFERINFO', 'DISPID_SPRuleParent',
    'SPAO_NONE', 'ISpStreamFormatConverter', 'SRSEIsSpeaking',
    'DISPID_SOTCId', 'ISpRecoGrammar2', 'DISPID_SWFEChannels',
    'SPAUDIOOPTIONS', 'SPBOOKMARKOPTIONS', 'SSFMCreateForWrite',
    'SVF_Stressed', 'DISPID_SDKDeleteKey', 'SREFalseRecognition',
    'SpStreamFormatConverter', 'SP_VISEME_15',
    'DISPID_SRGDictationLoad', 'DISPID_SRRAudio',
    'SpeechEngineProperties', 'SPCONTEXTSTATE', 'SVSFlagsAsync',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPGRAMMARSTATE',
    'SPSTREAMFORMATTYPE', 'SECFNoSpecialChars',
    'DISPID_SOTGetStorageFileName', 'SP_VISEME_3', 'DISPID_SBSRead',
    'SPEI_PHRASE_START', 'DISPID_SpeechLexiconProns',
    'ISpPhoneticAlphabetConverter', 'SAFT8kHz8BitStereo',
    'SpeechTokenShellFolder', 'SPEI_SR_PRIVATE',
    'SVSFParseAutodetect', 'DISPID_SPPFirstElement', 'SVSFDefault',
    'SPEI_UNDEFINED', 'DISPID_SpeechRecoContext',
    'DISPID_SpeechVoiceStatus', 'ISpRecoGrammar', 'SITooSlow',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE1',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpStream', 'SpWaveFormatEx',
    'eLEXTYPE_VENDORLEXICON', 'SDTProperty', 'SAFT24kHz8BitMono',
    'SPEI_INTERFERENCE', 'DISPID_SRRPhraseInfo', 'SRERequestUI',
    'SAFT44kHz16BitStereo', 'tagSPPROPERTYINFO',
    'ISpeechGrammarRuleStateTransition', 'SPWORDTYPE',
    'eLEXTYPE_PRIVATE2', 'ISpeechAudioStatus', 'eLEXTYPE_PRIVATE11',
    'ISpRecoCategory', 'SRAExport', 'DISPID_SLAddPronunciation',
    ...
    'eLEXTYPE_PRIVATE7', 'SP_VISEME_18', 'SP_VISEME_20',
    'SPFM_CREATE', 'SVPOver', 'SVP_2', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPAR_Low', 'SPFILEMODE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SLGetGenerationChange', 'DISPIDSPTSI_ActiveOffset',
    'SPEI_SENTENCE_BOUNDARY', 'ISpDataKey', 'DISPID_SLGetWords',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPEI_VISEME',
    'DISPID_SVAlertBoundary', 'SPAUDIOSTATUS', 'DISPID_SPPParent',
    'SAFTCCITT_ALaw_44kHzMono', 'SVPAlert', 'SPEI_RECO_STATE_CHANGE',
    'SREPrivate', 'DISPID_SGRsFindRule', 'SSSPTRelativeToEnd',
    'DISPID_SDKCreateKey', 'SVP_10', 'SVP_17', 'DISPID_SPIProperties',
    'SPWORDPRONUNCIATION', 'DISPID_SOTsItem',
    'DISPID_SRGSetWordSequenceData', 'SPBO_NONE', 'SPEI_SR_BOOKMARK',
    'DISPID_SVVolume', 'SDTDisplayText', 'DISPID_SRIsUISupported',
    ...
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT8kHz16BitMono',
    'DISPID_SRCEventInterests', 'SVEEndInputStream',
    'DISPID_SVEBookmark', 'SPDKL_CurrentConfig',
    'DISPID_SGRs_NewEnum', 'SVP_12', 'DISPID_SpeechXMLRecoResult',
    'SVEPrivate', 'DISPID_SWFESamplesPerSec',
    'ISpeechPhraseAlternate', 'SAFTADPCM_8kHzMono',
    'SpTextSelectionInformation', 'ISpRecoResult',
    'DISPID_SPRDisplayAttributes', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPIRule', 'DISPID_SPPName', 'SpeechRecognitionType',
    '_ISpeechVoiceEvents', 'SAFTADPCM_11kHzMono', 'SRAONone',
    'SPSNotOverriden', 'SPCT_COMMAND', 'eLEXTYPE_USER',
    'DISPID_SPRsCount', 'SVP_1', 'SGRSTTDictation',
    'eLEXTYPE_MORPHOLOGY', 'SP_VISEME_11', 'SSFMCreate',
    'WAVEFORMATEX', 'DISPID_SPIAudioSizeTime', 'SSFMOpenReadWrite',
    'SVP_15', 'ISpeechMMSysAudio', 'SPBO_AHEAD', 'eLEXTYPE_RESERVED6',
    'eLEXTYPE_RESERVED7', 'SpeechAddRemoveWord',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPAStartElementInResult',
    'DISPID_SVSpeakStream', 'DISPID_SMSADeviceId', 'DISPID_SRGState',
    'ISpeechPhraseProperties', 'ISpeechXMLRecoResult',
    'SAFTCCITT_uLaw_44kHzMono', 'eLEXTYPE_PRIVATE10', 'STSF_AppData',
    'DISPID_SRCRecognizer', 'DISPID_SGRSAddSpecialTransition',
    'SVSFVoiceMask', 'ISpResourceManager', 'eLEXTYPE_PRIVATE8',
    'SpInProcRecoContext', 'DISPID_SpeechPhraseElements',
    'SREAudioLevel', 'SPPHRASEREPLACEMENT', 'DISPID_SRCState',
    'SVP_9', 'Speech_Default_Weight', 'DISPID_SLWPronunciations',
    'SpeechTokenValueCLSID', 'DISPID_SFSClose',
    'DISPID_SpeechAudioBufferInfo', 'SVSFParseSsml',
    'SpeechInterference', 'SPLOADOPTIONS', 'DISPID_SGRsAdd',
    'SRTEmulated', 'DISPID_SRGCmdLoadFromObject',
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTDisplayUI',
    'ISpeechRecoResultDispatch', 'DISPID_SPRuleEngineConfidence',
    'SGLexical', 'SREAdaptation', 'DISPID_SRRecognizer',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRAudioInput', 'SpeechFormatType',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPERequiredConfidence',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_VOICE_CHANGE',
    'SPSNoun', 'DISPID_SRRSetTextFeedback', 'DISPID_SGRSRule',
    'ISpeechObjectTokenCategory', 'SP_VISEME_21',
    'DISPID_SPIGetDisplayAttributes', 'SVP_4',
    'DISPID_SDKSetLongValue', 'DISPID_SPPValue', 'eLEXTYPE_PRIVATE14',
    'SpeechVoiceSpeakFlags', 'SPRS_ACTIVE',
    'DISPID_SPERetainedSizeBytes', 'SAFT24kHz16BitMono',
    'DISPID_SPIEnginePrivateData', 'SGLexicalNoSpecialChars',
    'DISPID_SOTGetAttribute', 'DISPID_SPEDisplayText',
    'SPINTERFERENCE_NONE', 'SpMemoryStream',
    'SpeechPropertyResponseSpeed', 'Speech_StreamPos_RealTime',
    'SAFT22kHz8BitMono', 'SP_VISEME_9', 'SPEVENT', 'STCAll',
    'DISPID_SOTIsUISupported', 'DISPID_SRGetRecognizers',
    'DISPID_SVSLastStreamNumberQueued', 'Speech_Max_Pron_Length',
    'DISPID_SRProfile', 'SAFT16kHz8BitStereo', 'SRARoot',
    'DISPID_SPIAudioStreamPosition',
    'DISPID_SVSyncronousSpeakTimeout', 'STSF_LocalAppData',
    'eLEXTYPE_RESERVED8', 'DISPID_SGRSTNextState',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRCEBookmark',
    'SPPHRASERULE', 'SVP_20', 'DISPID_SDKOpenKey',
    'SPRECORESULTTIMES', 'SREPropertyNumChange',
    'DISPID_SRAudioInputStream', 'ISpeechRecognizerStatus',
    'DISPID_SMSSetData', 'SRSEDone', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRRSpeakAudio', 'SAFT32kHz8BitMono', 'LONG_PTR',
    'DISPID_SpeechObjectToken', 'SpeechAllElements', 'DISPID_SRGId',
    'DISPID_SPEPronunciation', 'DISPID_SRCERequestUI',
    'DISPID_SRGetFormat', 'SPEI_RESERVED6', 'SVP_13', 'ISpPhrase',
    'DISPID_SDKGetStringValue', 'ISpeechAudioBufferInfo',
    'DISPID_SGRId', 'ISpeechPhraseInfoBuilder', 'SPXMLRESULTOPTIONS',
    'SAFT22kHz16BitMono', 'DISPID_SGRAddState', 'SPDKL_LocalMachine',
    'DISPID_SOTRemove', 'IEnumString', 'DISPID_SLPLangId',
    'SPPARTOFSPEECH', 'SREBookmark', 'DISPID_SPELexicalForm',
    'SRTReSent', 'SECFIgnoreCase', 'SpeechCategoryRecognizers',
    'DISPID_SRRTLength', 'ISpeechPhraseReplacement', 'SPSVerb',
    'SpAudioFormat', 'DISPID_SASetState', 'SDTRule',
    'SAFT24kHz16BitStereo', 'SAFTADPCM_44kHzMono',
    'DISPID_SpeechRecoResult2', 'SASRun', 'SAFT44kHz8BitStereo',
    'SpeechAudioVolume', 'SpCompressedLexicon',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCESoundStart',
    'SP_VISEME_0', 'SECLowConfidence', 'SDA_One_Trailing_Space',
    'DISPID_SRCERecognizerStateChange', 'SAFTCCITT_ALaw_22kHzMono',
    'SPGS_ENABLED', 'DISPID_SLWWord', 'SpeechWordType',
    'SPPS_NotOverriden', 'DISPID_SpeechMMSysAudio',
    'ISpeechRecoResult2', 'DISPID_SPIStartTime',
    'SAFTExtendedAudioFormat', 'SGSEnabled', 'SVP_5',
    'ISpXMLRecoResult', 'SECHighConfidence', 'SAFT8kHz8BitMono',
    'DISPID_SpeechObjectTokens', 'SECFIgnoreKanaType',
    'SDTReplacement', 'SPEVENTENUM', 'SVSFParseMask',
    'SPEI_FALSE_RECOGNITION', 'ISpEventSource',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_RESERVED2',
    'SAFTNonStandardFormat', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFTCCITT_ALaw_8kHzMono',
    '_ISpeechRecoContextEvents', 'DISPID_SRSetPropertyString',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpShortcut',
    'SPRST_INACTIVE', 'DISPID_SGRsCount', 'SRCS_Enabled',
    'ISpSerializeState', 'DISPID_SRCEEnginePrivate', 'SPPS_RESERVED4',
    'DISPID_SpeechLexiconWords', 'DISPID_SBSWrite',
    'DISPID_SPRulesItem', 'SpeechGrammarTagUnlimitedDictation',
    'STCInprocHandler', 'DISPID_SAFSetWaveFormatEx', 'SINone',
    'DISPID_SWFEBlockAlign', 'DISPID_SOTGetDescription',
    'SRSActiveAlways', 'DISPID_SRCRetainedAudio', 'UINT_PTR',
    'ISpeechGrammarRules', 'SpeechRecognizerState',
    'DISPID_SVDisplayUI', 'DISPID_SPPNumberOfElements',
    ...
    'SpeechRecoProfileProperties', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPISaveToMemory', 'SPDKL_DefaultLocation',
    'DISPIDSPTSI_SelectionLength', 'SAFT48kHz8BitMono',
    'ISpeechPhraseInfo', 'DISPID_SpeechPhraseAlternate',
    'ISpeechObjectTokens', 'SRESoundStart', 'SpSharedRecognizer',
    ...
    'SpeechCategoryPhoneConverters', 'ISpProperties', 'ISpEventSink',
    'SpShortcut', 'DISPID_SRCRequestedUIType',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_TTS_AUDIO_LEVEL',
    'SPRST_ACTIVE', 'SpeechBookmarkOptions', 'DISPID_SGRInitialState',
    'SDKLLocalMachine', 'DISPID_SPPEngineConfidence', 'SP_VISEME_12',
    'SPFM_OPEN_READONLY', 'DISPID_SPPId', 'SpeechAudioFormatGUIDWave',
    'DISPID_SAEventHandle', 'ISpeechLexiconWord',
    'DISPID_SVGetAudioInputs', 'SPEI_SR_RETAINEDAUDIO',
    'SWPUnknownWordPronounceable', 'SpeechCategoryRecoProfiles',
    'DISPID_SLWType', 'SpeechVisemeFeature',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpAudio', 'SPWF_SRENGINE',
    'SAFTDefault', 'SpeechGrammarRuleStateTransitionType',
    'SRSInactiveWithPurge', 'DISPID_SRGRecoContext',
    'DISPID_SPEAudioTimeOffset', 'SPWT_PRONUNCIATION',
    'DISPID_SRIsShared', 'DISPID_SVVoice', 'DISPID_SVSkip', 'SDTAll',
    'IStream', 'SPEI_START_SR_STREAM', 'ISpRecoContext2',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPRuleId',
    'SAFT8kHz16BitStereo', 'SAFT22kHz8BitStereo', 'SpeechTokenKeyUI',
    'SpeechDataKeyLocation', 'SPPS_RESERVED1',
    'DISPID_SPEAudioStreamOffset', 'SVP_3', 'SPAR_High',
    'SPWT_DISPLAY', 'SPSERIALIZEDPHRASE', 'DISPID_SASNonBlockingIO',
    'DISPID_SLRemovePronunciation', 'SpeechCategoryAppLexicons',
    'DISPID_SRSClsidEngine', 'DISPID_SVSInputSentencePosition',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechLexicon', 'SRESoundEnd',
    'SSSPTRelativeToCurrentPosition', 'ISpeechVoiceStatus',
    'SAFT32kHz16BitStereo', 'DISPID_SRCPause',
    ...
    'SPINTERFERENCE_TOOQUIET', 'SPSModifier', 'IEnumSpObjectTokens',
    'SPSEMANTICFORMAT', 'DISPID_SLPsItem',
    'DISPID_SREmulateRecognition', 'SPCT_DICTATION',
    'DISPID_SVEStreamEnd', 'SDKLDefaultLocation',
    'DISPID_SpeechAudioFormat', 'DISPID_SAStatus', 'SPINTERFERENCE',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPSFunction', 'SPEI_RESERVED3',
    'DISPID_SRCResume', 'SPEI_SR_AUDIO_LEVEL', 'SpeechLoadOption',
    'DISPID_SpeechWaveFormatEx', 'SVEBookmark', 'SpMMAudioOut',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVAudioOutputStream',
    'eLEXTYPE_PRIVATE4', 'SVP_21',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRERecognition',
    'DISPID_SRSCurrentStreamNumber', 'DISPIDSPRG',
    'SPINTERFERENCE_NOISE', 'DISPID_SABufferInfo',
    'DISPID_SRCEFalseRecognition', 'SPSMF_SAPI_PROPERTIES',
    'SVEStartInputStream', 'DISPID_SGRClear', 'SpeechUserTraining',
    'SpeechRegistryUserRoot', 'SpObjectToken',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpRecoContext',
    'DISPID_SGRSTPropertyName', 'SPSHT_NotOverriden', 'SFTInput',
    'SLOStatic', 'DISPID_SGRSAddRuleTransition',
    'SREPropertyStringChange', 'SAFT11kHz16BitMono', '_SPAUDIOSTATE',
    'SpLexicon', 'DISPID_SRCBookmark', 'ISpeechRecoResult',
    'DISPID_SOTRemoveStorageFileName', 'SVP_8', 'ISpGrammarBuilder',
    'SPEI_REQUEST_UI', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRSetPropertyNumber', 'SAFT12kHz8BitMono',
    'DISPID_SLPType', 'SP_VISEME_6', 'ISpObjectToken',
    'DISPID_SRCEInterference', 'DISPID_SOTCGetDataKey',
    'SPPS_RESERVED2', 'DISPID_SPEsCount', 'SPEI_END_INPUT_STREAM',
    'SRAInterpreter', 'SPEI_RESERVED5',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVSLastBookmark',
    'ISpeechWaveFormatEx', 'SPRULESTATE', 'SRERecoOtherContext',
    'DISPID_SpeechGrammarRules', 'SPRULE', 'eLEXTYPE_PRIVATE16',
    'DISPID_SVEWord', 'DISPID_SGRSTType', 'SPAUDIOSTATE',
    'DISPID_SMSGetData', 'DISPID_SRGDictationSetState',
    ...
    'DISPID_SRCCmdMaxAlternates', 'SpFileStream',
    'SpeechTokenIdUserLexicon', 'DISPID_SVPriority',
    'eLEXTYPE_PRIVATE15', 'eLEXTYPE_PRIVATE19',
    'DISPID_SOTCEnumerateTokens', 'SPINTERFERENCE_TOOFAST',
    'SRAImport', 'SpeechCategoryAudioIn', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechRecoContextEvents', 'SPFM_NUM_MODES', 'SVP_0',
    'SPLEXICONTYPE', 'SECNormalConfidence', 'tagSTATSTG',
    'SGRSTTEpsilon', 'SVSFPersistXML', 'SPSEMANTICERRORINFO',
    'eLEXTYPE_PRIVATE18', 'DISPID_SGRSTsCount',
    ...
    'DISPID_SVGetVoices', 'SpeechTokenKeyFiles', 'SPAS_STOP',
    'SDTPronunciation', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SVAudioOutput', 'SpeechGrammarTagWildcard',
    'DISPID_SOTCSetId', 'DISPID_SRCCreateGrammar', 'SGDSInactive',
    'STCInprocServer', 'SSSPTRelativeToStart', 'SRATopLevel',
    'DISPID_SPRsItem', 'SECFDefault', 'eLEXTYPE_PRIVATE9',
    'SpMMAudioEnum', 'SVP_14', 'SPPS_SuppressWord',
    'DISPID_SGRSTs_NewEnum', 'SITooFast', 'SSTTDictation',
    'SPRST_NUM_STATES', 'SpVoice', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SWFEExtraData', 'SGDSActiveUserDelimited', 'SREStreamEnd',
    'SPPHRASEELEMENT', 'ISpeechGrammarRule', 'SASStop',
    'ISpeechPhraseRule', 'ISpeechPhraseElements',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCESoundEnd',
    'DISPID_SPIGrammarId', 'ISpeechRecoGrammar', 'SPSHORTCUTTYPE',
    'DISPID_SPPs_NewEnum', 'ISpNotifySource', 'SREInterference',
    'ISpeechTextSelectionInformation', 'SAFT11kHz8BitMono',
    'DISPID_SPIElements', 'DISPID_SDKDeleteValue',
    'SPINTERFERENCE_TOOLOUD', 'SpMMAudioIn', 'SP_VISEME_4',
    'DISPID_SGRSTPropertyId', 'DISPID_SPEsItem', 'SPDKL_CurrentUser',
    'SpeechAudioFormatGUIDText', 'DISPID_SVEventInterests',
    'DISPID_SVStatus', 'DISPID_SRRAudioFormat', 'SVESentenceBoundary',
    'SpeechRecoContextState', 'SPEI_HYPOTHESIS', 'DISPID_SMSALineId',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SASFreeBufferSpace',
    'DISPID_SABIMinNotification', 'DISPID_SPIGetText',
    'SpeechEmulationCompareFlags', 'DISPID_SPRFirstElement',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpeechRunState',
    'SPWORDPRONOUNCEABLE', 'ISpLexicon', 'ISpObjectWithToken',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPVPRI_NORMAL',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVSLastResult',
    'DISPID_SRCEStartStream', 'eLEXTYPE_RESERVED9',
    'DISPID_SVSRunningState', 'SpeechVoiceEvents', 'SGRSTTWildcard',
    'SPGRAMMARWORDTYPE', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SVSInputSentenceLength', 'SAFTText',
    'DISPID_SPRuleChildren', 'SECFEmulateResult',
    'SPEI_END_SR_STREAM', 'SAFT32kHz16BitMono', 'SVP_19', 'SVP_7',
    'SAFTGSM610_11kHzMono', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SLPSymbolic', 'DISPID_SMSAMMHandle', 'SPWF_INPUT',
    'SpeechAudioFormatType', 'SpeechWordPronounceable', 'SBONone',
    'DISPID_SPPConfidence', 'DISPID_SRRGetXMLErrorInfo', 'SPAS_RUN',
    'DISPID_SABIEventBias',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpResourceManager', 'SRCS_Disabled', 'SPVOICESTATUS',
    'DISPID_SPERetainedStreamOffset', 'SpeechLexiconType',
    'SpeechRecoEvents', 'DISPID_SpeechPhraseRule', 'SPSHORTCUTPAIR',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SOTMatchesAttributes',
    'DISPID_SGRSTWeight', 'DISPID_SPEAudioSizeBytes',
    'SAFTGSM610_22kHzMono', 'ISpeechLexiconWords', 'SRTStandard',
    'SpeechDiscardType', 'SPCT_SLEEP', 'DISPID_SVEPhoneme',
    'DISPID_SRGRules', 'SVEWordBoundary', 'SpeechGrammarState',
    'SpeechAudioState', 'SAFT16kHz16BitStereo',
    'DISPID_SVEVoiceChange', 'STSF_FlagCreate',
    'DISPID_SVSpeakCompleteEvent', 'SDKLCurrentUser', 'SRSActive',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechPhoneConverter',
    'DISPID_SRStatus', 'SPEI_RECO_OTHER_CONTEXT', 'SpPhoneConverter',
    ...
    'SVSFIsXML', 'tagSPTEXTSELECTIONINFO', 'SpeechAudioProperties',
    'STCLocalServer', 'SDTAlternates', 'DISPID_SRGDictationUnload',
    'DISPID_SRCEAudioLevel', 'SVP_6', 'DISPID_SVSVisemeId',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SLTUser', 'SpSharedRecoContext',
    'ISpeechRecognizer', 'SpUnCompressedLexicon',
    'ISpeechLexiconPronunciation', 'SpeechVoicePriority',
    'STCRemoteServer', 'DISPID_SOTCategory', 'SPRS_INACTIVE',
    'DISPID_SASCurrentDevicePosition', 'ISpRecognizer2',
    'SAFT32kHz8BitStereo', 'SGRSTTRule', 'DISPID_SPRulesCount',
    'DISPID_SLWs_NewEnum', 'DISPID_SLPPhoneIds',
    'SPTEXTSELECTIONINFO', 'SREPhraseStart',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SVGetProfiles',
    'DISPID_SWFEFormatTag', 'DISPID_SPAsCount', 'SP_VISEME_17',
    'eLEXTYPE_RESERVED4', 'DISPID_SPPsItem', 'DISPID_SOTCDefault',
    'eWORDTYPE_ADDED', 'SPPS_Modifier', 'DISPID_SGRsDynamic',
    'SBOPause', 'ISpRecognizer3', 'ISpeechResourceLoader',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRRRecoContext', 'DISPID_SRRTimes',
    'SWPKnownWordPronounceable', 'SPEI_MIN_TTS',
    'DISPID_SVIsUISupported', 'SAFT12kHz16BitStereo',
    'DISPID_SVResume', 'SSFMOpenForRead', 'SPWT_LEXICAL',
    ...
    'DISPID_SLWLangId', 'SVP_11', 'SPLO_DYNAMIC',
    'DISPID_SpeechVoiceEvent', 'DISPID_SOTs_NewEnum',
    'SAFTNoAssignedFormat', 'SVP_16', 'SPPHRASEPROPERTY',
    'DISPID_SpeechCustomStream', 'SpeechSpecialTransitionType',
    'DISPID_SPACommit', 'DISPID_SpeechAudioStatus', 'DISPID_SFSOpen',
    'SPVPRI_OVER', 'SPEI_RESERVED1', 'ISpeechGrammarRuleState',
    'ISpNotifySink', 'SP_VISEME_7', 'DISPID_SPRText',
    'DISPID_SRCEEndStream', 'SWTAdded', 'SVSFNLPMask',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechBaseStream', 'SPWORDLIST',
    'DISPID_SRCVoice', 'DISPID_SRRDiscardResultInfo',
    'SpObjectTokenCategory', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRCEPhraseStart', 'SpeechRuleState',
    'DISPID_SVEEnginePrivate', 'SGRSTTTextBuffer', 'SGSExclusive',
    'DISPID_SpeechPhraseRules', 'SPWORD', 'SpeechTokenContext',
    'ISpMMSysAudio', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPRuleNumberOfElements', 'SVSFIsNotXML',
    'DISPID_SRCERecognition', 'ISpeechFileStream', 'SpCustomStream',
    'SAFT48kHz16BitMono', 'ISpeechPhraseReplacements',
    'DISPIDSPTSI_ActiveLength', 'ISpeechVoice', 'SFTSREngine',
    'SPEI_PHONEME', 'DISPIDSPTSI_SelectionOffset', 'SREHypothesis',
    'SRTExtendableParse', 'DISPID_SpeechPhraseElement', 'SGRSTTWord',
    'SpeechCategoryVoices', 'SpPhraseInfoBuilder',
    'DISPID_SpeechPhoneConverter', 'SPAR_Medium',
    'SpeechEngineConfidence', 'SpeechDisplayAttributes',
    'DISPID_SpeechDataKey', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SAFTGSM610_8kHzMono', 'SPPS_Noncontent', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPCIdToPhone', 'SpeechPropertyAdaptationOn',
    'SAFT11kHz8BitStereo', 'DISPID_SLPs_NewEnum',
    'DISPID_SLGetPronunciations', 'DISPID_SRSSupportedLanguages',
    'DISPID_SGRAttributes', 'DISPID_SPIAudioSizeBytes',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechPhraseAlternates',
    'DISPID_SpeechRecoResult', 'DISPID_SVEStreamStart',
    'DISPID_SGRsItem', 'SpInprocRecognizer', 'DISPID_SLGenerationId',
    'DISPIDSPTSI', 'DISPID_SpeechVoice', 'DISPID_SGRSTsItem',
    'SVSFNLPSpeakPunc', 'SP_VISEME_8',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRGReset',
    'SPEVENTSOURCEINFO', 'SPXRO_SML', 'SPSERIALIZEDRESULT',
    'SPSHT_OTHER', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SVEAudioLevel', 'SpNotifyTranslator', 'SLTApp',
    'SECFIgnoreWidth', 'DISPID_SpeechAudio',
    'SAFTCCITT_uLaw_8kHzMono', 'SVSFPurgeBeforeSpeak', 'SPVPRI_ALERT',
    'SASClosed', 'SLODynamic', 'eLEXTYPE_PRIVATE6',
    'SpeechStreamSeekPositionType', 'eLEXTYPE_APP', 'SPCS_DISABLED',
    'DISPID_SRSAudioStatus', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechDictationTopicSpelling', 'SPEI_MAX_SR',
    'ISpeechMemoryStream', 'DISPID_SOTCreateInstance',
    'SPPROPERTYINFO', 'SPBO_PAUSE', 'SRADynamic',
    'SpPhoneticAlphabetConverter', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SASState', 'ISpeechAudioFormat', 'SPSSuppressWord',
    'eLEXTYPE_PRIVATE17', 'SGDSActive', 'DISPID_SGRSTText',
    ...
    'ISequentialStream', 'SPCT_SUB_DICTATION', 'SPPS_LMA',
    'SpeechTokenKeyAttributes', 'DISPID_SPCLangId',
    'ISpeechPhraseProperty', 'SAFTADPCM_22kHzMono',
    'ISpeechPhraseRules', 'SAFTGSM610_44kHzMono',
    'SPXRO_Alternates_SML', 'SGSDisabled', 'SVPNormal', 'SPSUnknown',
    'DISPID_SGRAddResource', 'SPEI_WORD_BOUNDARY', 'SPPS_Verb',
    'DISPID_SVSpeak', 'SDTAudio', 'DISPID_SRGetPropertyString',
    'DISPID_SVSInputWordLength', 'eWORDTYPE_DELETED', 'SPAR_Unknown',
    'SPAS_CLOSED', 'DISPID_SVSLastBookmarkId',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'Speech_Max_Word_Length',
    'SGDisplay', 'SpeechVisemeType', 'SSTTTextBuffer',
    'DISPID_SPRules_NewEnum', 'DISPID_SDKGetlongValue',
    'DISPID_SRRTTickCount', 'DISPID_SBSFormat',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpStreamFormat',
    'ISpNotifyTranslator', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRGCmdSetRuleState', 'SPCS_ENABLED',
    'eLEXTYPE_RESERVED10', 'DISPID_SLWsCount', 'SPVPRIORITY',
    'DISPID_SpeechGrammarRule',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT44kHz8BitMono',
    'SP_VISEME_1', 'SAFT11kHz16BitStereo', 'SPGS_DISABLED',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPEDisplayAttributes',
    'SpeechGrammarTagDictation', 'SPPHRASE', 'DISPID_SOTsCount',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPARecoResult',
    'SVSFIsFilename', 'SAFTCCITT_uLaw_11kHzMono', 'SVEAudioLevel',
    'SVF_None', 'DISPID_SVPause', 'DISPID_SRRSaveToMemory',
    'ISpeechCustomStream', 'SP_VISEME_16', 'SPAS_PAUSE',
    'DISPID_SAFGetWaveFormatEx', 'SpeechVoiceCategoryTTSRate',
    'SPSHT_Unknown', 'STSF_CommonAppData', 'DISPID_SAFGuid',
    'ISpVoice', 'SPDATAKEYLOCATION', 'DISPID_SpeechPhraseInfo',
    'DISPID_SABufferNotifySize', 'SPEI_START_INPUT_STREAM',
    'SpeechRuleAttributes', 'DISPID_SDKEnumValues',
    'DISPID_SABIBufferSize', 'SpeechStreamFileMode',
    'DISPID_SPPChildren', 'SPCATEGORYTYPE', 'eLEXTYPE_USER_SHORTCUT',
    'SITooLoud', 'DISPID_SLPPartOfSpeech',
    ...
    'ISpeechDataKey', 'SPSLMA', 'SpeechMicTraining',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCEHypothesis',
    'SPWORDPRONUNCIATIONLIST', 'SVEAllEvents', 'SRTAutopause',
    'DISPID_SVESentenceBoundary', 'SPSMF_UPS',
    'DISPID_SVWaitUntilDone', 'DISPID_SPEs_NewEnum', 'SVEVoiceChange',
    'DISPID_SCSBaseStream', 'SGPronounciation', 'SREAllEvents',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SVRate',
    'SPEI_SOUND_START', 'SP_VISEME_14', 'ISpeechRecoResultTimes',
    'SP_VISEME_13', 'SINoSignal', 'SP_VISEME_2', 'ISpPhraseAlt',
    'DISPID_SAVolume', 'SPBINARYGRAMMAR', 'SDA_Two_Trailing_Spaces',
    'SGDSActiveWithAutoPause', 'DISPID_SPRs_NewEnum', 'SPEI_MAX_TTS',
    'ISpeechAudio', 'SRSInactive', 'SPCT_SUB_COMMAND',
    'SREStateChange', 'SVSFUnusedFlags', 'SREStreamStart',
    'SAFT22kHz16BitStereo', 'SPPS_Unknown',
    'ISpeechLexiconPronunciations', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SpeechPhraseBuilder', 'SP_VISEME_5', 'ISpeechLexicon',
    'IInternetSecurityManager', 'SPPS_Noun', 'DISPID_SRRAlternates',
    'SAFT48kHz16BitStereo', 'SASPause', 'SVSFParseSapi',
    'DISPID_SPEActualConfidence', 'SPEI_MIN_SR', 'SPVISEMES',
    'eLEXTYPE_PRIVATE13', 'SPPS_Interjection', 'DISPID_SGRName',
    'SPPS_RESERVED3', 'SAFT12kHz8BitStereo', 'SPBO_TIME_UNITS',
    'SAFT16kHz16BitMono', 'SpeechRetainedAudioOptions', 'SVEPhoneme',
    'DISPID_SRGSetTextSelection', 'SINoise', 'DISPID_SPEAudioSizeTime'
]

_check_version('1.2.0', 1700136949.594218)
